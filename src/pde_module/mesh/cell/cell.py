...
from .functions import check_cell_types,calculate_cell_centroids,calculate_cell_volumes,calculate_neighbors
...
class Cells:
    ...
    def get_neighbors(self,cell_to_face,cell_to_face_offset,ownerNeighbor):
        '''
        neighbors: an N,2 Array of ints that stores the nieghboring cellID and the corresponding faceID
        '''
