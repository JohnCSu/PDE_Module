...
def generate_cube_mesh(
    ...
    """
    Generate a cube mesh using Gmsh.
...
def generate_cube_mesh_simple(
    size: float = 1.0,
    divisions: int = 2,
    cell_type: CellType = "hex",
) -> Mesh:
    """
    Simplified cube mesh generator with uniform parameters.

    Args:
        size: Edge length of the cube
        divisions: Number of elements per edge
        cell_type: "hex" | "tet" | "wedge"
